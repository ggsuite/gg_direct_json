...
void main() {
  group('gg_direct_json_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_direct_json_version.dart');
